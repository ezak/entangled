...
if (NOT __UNITY_INCLUDED)
  ...
  ExternalProject_Add(
    ...
    CMAKE_ARGS
      ...
      -DCMAKE_INSTALL_PREFIX:STRING=${ANDROID_INSTALL_ROOT}
      -DCMAKE_FIND_ROOT_PATH:STRING=${ANDROID_INSTALL_ROOT}
      -DCMAKE_INCLUDE_PATH:STRING=${CMAKE_INCLUDE_PATH}
      -DCMAKE_INSTALL_PREFIX:PATH:STRING=${CMAKE_INSTALL_PREFIX}
